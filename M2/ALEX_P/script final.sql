...
-- -----------------------------------------------------
-- Table `AMS`.`CHARACTER_HAS_ADVENTURE`
-- -----------------------------------------------------
...
-- Table `AMS`.`DECISION`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `AMS`.`CHOICE` (
  ...
  `FK_STEP_ID_STEP` INT NOT NULL,
  `FK_STEP_ADVENTURE_ID_ADVENTURE` INT NOT NULL,
  PRIMARY KEY (`ID_DECISION`, `FK_GAME_ID_GAME`, `FK_GAME_USER_ID_USER`, `FK_GAME_ADVENTURE_ID_ADVENTURE`, `FK_GAME_CHARACTER_ID_CHARACTER`, `FK_OPTION_ID_OPTION`, `FK_STEP_ID_STEP`, `FK_STEP_ADVENTURE_ID_ADVENTURE`),
  UNIQUE INDEX `_UNIQUE` (`ID_DECISION` ASC) VISIBLE,
  ...
  INDEX `fk_DECISION_OPTION1_idx` (`FK_OPTION_ID_OPTION` ASC, `FK_STEP_ID_STEP` ASC, `FK_STEP_ADVENTURE_ID_ADVENTURE` ASC) VISIBLE,
  CONSTRAINT `FK_CHOICE_GAME1`
